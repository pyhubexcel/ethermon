...
def update_internal_transform_contract():
	...
	print ("good guy transaction_list")
	...
	print("events_start_update_transform_contract|current_block=%s,start_block=%s,end_block=%s,len_txn=%s", current_block, start_block, end_block, len(event_list))
